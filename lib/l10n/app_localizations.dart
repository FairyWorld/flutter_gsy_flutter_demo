...
abstract class AppLocalizations {
  ...
  /// No description provided for @allExamples.
  ///
  /// In en, this message translates to:
  /// **'All examples'**
  ...
  /// No description provided for @currentShown.
  ///
  /// In en, this message translates to:
  /// **'Shown'**
  String get currentShown;
  ...
  /// No description provided for @noMatchExamples.
  ///
  /// In en, this message translates to:
  /// **'No matching examples'**
  String get noMatchExamples;
  ...
  /// No description provided for @categoryScroll.
  ///
  /// In en, this message translates to:
  /// **'Scrolling'**
  String get categoryScroll;
  ...
  /// No description provided for @categoryCanvas.
  ///
  /// In en, this message translates to:
  /// **'Canvas & Shader'**
  String get categoryCanvas;

...
class LoadingAnimButton extends StatefulWidget {
  ...
  const LoadingAnimButton(
      {super.key, this.loadingState, this.loadingSpeed = 2});
...
class LoadingButtonPainter extends CustomPainter {
  ...
  initSizeAndPath(Size size) {
    ...
    rect = Rect.fromLTRB(centerX - circleRadius, centerY + 0.6 * circleRadius,
        centerX + circleRadius, centerY + 2.6 * circleRadius);

...
class ClockPainter extends CustomPainter {
  ...
  void intiSize(int w, int h) {
    ...
    earRectF = Rect.fromLTRB(
        centerX! - clockEarRadius!,
        centerY! - clockEarRadius!,
        centerX! + clockEarRadius!,
        centerY! + clockEarRadius!);
  ...
  void initCoordinates() {
    ...
    double footRightStartX =
        ((clockRadius! + clockStrokeWidth! / 2) * cos(footRightAngel!) +
            centerX!);
    double footRightStartY =
        ((clockRadius! + clockStrokeWidth! / 2) * sin(footRightAngel!) +
            centerY!);
    ...
    double footLeftStartX =
        ((clockRadius! + clockStrokeWidth! / 2) * cos(footLeftAngel!) +
            centerX!);
    double footLeftStartY =
        ((clockRadius! + clockStrokeWidth! / 2) * sin(footLeftAngel!) +
            centerY!);
    footLeftStartPointF = Offset(footLeftStartX, footLeftStartY);

    double footLeftEndX =
        (footCalculateRadius! * cos(footLeftAngel!) + centerX!);
    double footLeftEndY =
        (footCalculateRadius! * sin(footLeftAngel!) + centerY!);
  ...
  void drawClock(Canvas canvas) {
    canvas.drawCircle(
        Offset(centerX!, centerY!), clockRadius!, clockCirclePaint);
